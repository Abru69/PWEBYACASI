...
$productos = array(
    array("id" => "7", "nombre" => "Cubeta 8pz", "imagen" => "../IMG/Pollo1.jpeg", "descripcion" => ""),
    array("id" => "8", "nombre" => "Cubeta 12pz", "imagen" => "../IMG/Pollo2.jpeg", "descripcion" => ""),
    array("id" => "9", "nombre" => "Cubeta 18pz", "imagen" => "../IMG/Pollo3.jpeg", "descripcion" => ""),
