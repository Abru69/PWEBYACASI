...
$productos = array(
    array("id" => "1", "nombre" => "Hamburguesa", "imagen" => "../IMG/HAMBURGUESA.jpg", "descripcion" => ""),
    array("id" => "2", "nombre" => "Hot Dog", "imagen" => "../IMG/HOTDOG.jpg", "descripcion" => ""),
    array("id" => "3", "nombre" => "Papas Fritas", "imagen" => "../IMG/PAPAS.jpg", "descripcion" => ""),
